...
public class AIIron : MonoBehaviour
{
    public MineAppear script;
    ...
    void Start()
    {
        ...
        script = GetComponent<MineAppear>();
        ...
        if (AIBuildStrategy.strategy == 1)
        {
            if (!transform.GetChild(1).gameObject.activeInHierarchy)
            {
                ...
                if (AIWorkings.marketStolen == true || PointSystem.wood1 > 160 || PointSystem.stone1 > 160 || PointSystem.iron1 > 160 || PointSystem.soil1 > 160)
                {
                    ...
                    if (PointSystem.wood1 > 40 && PointSystem.stone1 > 20 && PointSystem.soil1 > 20 && PointSystem.iron1 > 10)
                    {
                        PointSystem.wood1 = PointSystem.wood1 - 40;
                        PointSystem.stone1 = PointSystem.stone1 - 20;
                        PointSystem.soil1 = PointSystem.soil1 - 20;
                        PointSystem.iron1 = PointSystem.iron1 - 10;
